...
final class EventSchedulerDependencies {
    ...
    init(courierNetworkBuider: any NetworkBuildable,
         db: Database,
    ...
    */
    ...
    private lazy var courierEventBatchCreator: CourierEventBatchCreator = {
        CourierEventBatchCreator(
            with: self.courierNetworkBuider,
    ...
    /// Call this method to get the CourierEventWarehouser instance.
    /// - Returns: CourierEventWarehouser instance.
