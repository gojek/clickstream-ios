...
class CourierRetryMechanism: Retryable {
    ...
    fileprivate let performQueue: SerialQueue
    ...
    fileprivate var retryTimer: DispatchSourceTimer?
...
extension CourierRetryMechanism {
    ...
    fileprivate func retryFailedBatches() {
...
final class CourierRetryMechV2: CourierRetryMechanism {
